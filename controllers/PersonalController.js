            ...
            if (validData.errors.length > 0) {
                ...
                if (personals) {
                    ...
                    if (!personalExists) {
                        ...
                        console.log('Item 1: ', arrayItem[PersonalController.randomIndex(items)]);
                        console.log('Item 2: ', arrayItem[PersonalController.randomIndex(items)]);
                        console.log('Credit limit: ', arrayCreditlimit[PersonalController.randomIndex(arrayCreditlimit)]);
