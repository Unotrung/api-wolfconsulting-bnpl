...
const { MSG_PERSONAL_IS_EXISTS, MSG_PHONE_PHONE_REF_IS_SAME,
    MSG_UPDATE_FAILURE, MSG_TENOR_IS_NOT_EXISTS } =
...
const { MSG_GET_LIST_SUCCESS, MSG_LIST_IS_EMPTY, MSG_ADD_SUCCESSFULLY, MSG_ADD_FAILURE, MSG_PERSONAL_IS_EXISTS,
    ...
    MSG_SEND_OTP_FAILURE, MSG_OTP_EXPIRED, MSG_OTP_VALID, MSG_OTP_INVALID, MSG_WRONG_NID } = require('../config/response/response');
